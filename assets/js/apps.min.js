...
var handleSlimScroll = function() {
  ...
  , handleMobileSidebarToggle = function() {
    ...
    $(document).bind("click touchstart", function(a) {
        ...
        a.isPropagationStopped() || !0 === e || ($("#page-container").hasClass("page-sidebar-toggled") && (e = !0,
        $("#page-container").removeClass("page-sidebar-toggled")),
        $(window).width() <= 767 && $("#page-container").hasClass("page-right-sidebar-toggled") && (e = !0,
  ...
  , handleSidebarMinify = function() {
    $("[data-click=sidebar-minify]").click(function(e) {
        ...
        $("#page-container").hasClass("page-sidebar-minified") ? ($("#page-container").removeClass("page-sidebar-minified"),
        $("#page-container").hasClass("page-sidebar-fixed") ? (0 !== $("#sidebar .slimScrollDiv").length && ($('#sidebar [data-scrollbar="true"]').slimScroll({
            destroy: !0
        }),
        ...
        $('#sidebar [data-scrollbar="true"]').removeAttr("style")),
        generateSlimScroll($('#sidebar [data-scrollbar="true"]')))) : ($("#page-container").addClass("page-sidebar-minified"),
        ...
        $('#sidebar [data-scrollbar="true"]').css("overflow", "visible")) : ($("#page-container").hasClass("page-sidebar-fixed") && ($('#sidebar [data-scrollbar="true"]').slimScroll({
            destroy: !0
        }),
        $('#sidebar [data-scrollbar="true"]').removeAttr("style")),
  ...
  , handleUnlimitedTabsRender = function() {
    ...
    function a(e, a) {
        ...
        case "prev":
            var l = -i;
            l <= n ? ($(t).removeClass("overflow-left"),
            s = 0) : s = l - n + 80,
  ...
  , handleUnlimitedTopMenuRender = function() {
    ...
    function e(e, a) {
        ...
        case "prev":
            var l = -i;
            l <= n ? ($(t).find(".menu-control.menu-control-left").removeClass("show"),
            s = 0) : s = l - n + 88,
            $(t).animate({
                marginLeft: "-" + s + "px"
            }, 150, function() {
