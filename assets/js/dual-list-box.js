(function($) {
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).addClass('row').append(
                ...
                '       <h4><span class="unselected-title"></span> <small>- menampilkan <span class="unselected-count"></span> data siswa</small></h4>' +
                ...
                (options.horizontal == false ? '   <div class="col-md-5">' : '   <div class="col-md-6">') +
                '       <h4><span class="selected-title"></span> <small>- menampilkan <span class="selected-count"></span> data siswa</small></h4>' +
        ...
        $(options.parentElement + ' .unselected-title').text('Data Siswa Tidak Terpilih ' );
        $(options.parentElement + ' .selected-title').text('Data Siswa Terpilih ' );
    }
