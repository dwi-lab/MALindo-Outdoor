...
var handleDatepicker = function() {
  ...
  , handleIonRangeSlider = function() {
    $("#nilai_mtks").ionRangeSlider({
        ...
        onFinish: function (data) {
            jQuery("#min_mtk").val(data.fromNumber);
            jQuery("#max_mtk").val(data.toNumber);
        },
        onUpdate: function (data) {
            console.log(data);
        }
    }),
    $("#nilai_indo").ionRangeSlider({
        min: 30,
        max: 90,
        step: 1,
        type: "double",
    ...
    $("#nilai_produktif").ionRangeSlider({
        min: 30,
        max: 90,
        step: 1,
        type: "double",
 ...
 , handleFormMaskedInput = function() {
    ...
    $("#masked-input-date_mulai").mask("99-99-9999"),
    $("#masked-input-date_selesai").mask("99-99-9999"),
    $("#mulai").mask("99:99:99"),
    $("#selesai").mask("99:99:99"),
    $("#tepat").mask("99:99:99"),
    $("#terlambat").mask("99:99:99"),
    $("#pulang").mask("99:99:99"),
    $("#lembur").mask("99:99:99"),
