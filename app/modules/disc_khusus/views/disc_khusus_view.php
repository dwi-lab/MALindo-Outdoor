...
<script src="<?php echo base_url();?>assets/js/disc_khusus.js"></script>
					...
					class="table table-striped table-bordered nowrap" width="100%"> 
						<thead> 
							<tr> 
								...
								<th style="text-align:center" width="50%">Nama Diskon</th>  
								<th style="text-align:center" width="20%">Tgl Mulai</th>  
								<th style="text-align:center" width="20%">Tgl Selesai</th>  
								<th style="text-align:center" width="20%">Diskon (%)</th>  
				...
				<form action="#" id="form" class="form-horizontal">
					...
					<div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama Diskon  </label>
                            <div class="col-md-8">
                                <div class="input-group date" id="">
                                    <input name="nama" id="nama" maxlength="150" class="form-control" type="text">
					...
					<div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-group date" id="">
                                    <input name="diskon" id="diskon" style="text-align: right;" maxlength="150" class="form-control" type="text">
