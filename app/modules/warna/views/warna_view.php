...
<script src="<?php echo base_url();?>assets/js/warna.js"></script>
<div class="row"> 
	<div class="col-md-12"> 
					...
					class="table table-striped table-bordered nowrap" width="100%"> 
						<thead> 
							<tr> 
								...
								<th style="text-align:center" width="80%">Nama Warna</th>  
				...
				<form action="#" id="form" class="form-horizontal">
					...
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-6">
								<input name="nama" id="nama" maxlength="30" placeholder="Masukan Nama Warna" class="form-control" type="text">
