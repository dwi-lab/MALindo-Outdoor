...
class Pemeliharaan_model extends CI_Model {
    var $table         = 'view_pemeliharaan';
    var $column_order  = array('kode_transaksi','nama_mitra','tgl_pemeliharaan','kontak','no_kontak','email',null);
    var $column_search = array('kode_transaksi','nama_mitra','tgl_pemeliharaan','kontak','no_kontak','email'); 
