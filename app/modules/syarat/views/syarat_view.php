...
<script src="<?php echo base_url();?>assets/js/syarat.js"></script>
<div class="row"> 
	<div class="col-md-12"> 
				...
				<form action="#" id="form" class="form-horizontal">
					...
					<div class="form-body">
						<div class="form-group">
							<div class="col-md-12">
								<input name="nama" id="nama" placeholder="Masukan Keterangan Persyaratan" class="form-control" type="text">
