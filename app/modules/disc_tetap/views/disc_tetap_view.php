...
<script src="<?php echo base_url();?>assets/js/disc_tetap.js"></script>
<div class="row"> 
	<div class="col-md-12"> 
					...
					class="table table-striped table-bordered nowrap" width="100%"> 
						<thead> 
							<tr> 
								...
								<th style="text-align:center" width="50%">Lama Pinjam (hari)</th>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-group date" id="">
                                    <input name="lama" id="lama" style="text-align: right;" maxlength="150" class="form-control" type="text">
