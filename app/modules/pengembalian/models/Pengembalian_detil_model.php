...
class Pengembalian_detil_model extends CI_Model {
    var $table         = 'view_pengembalian_detil';
    var $tablex        = 'view_pengembalian';
    var $table_        = 'tbl_pengembalian_detil';
    var $table__       = 'tbl_pengembalian';
    ...
    public function get_by_kode_transaksi($id){
