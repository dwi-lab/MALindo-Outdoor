...
<script src="<?php echo base_url();?>assets/js/sewa_detil.js"></script>
                                ...
                                <tr class="highlight">
                                    ...
                                    <td>
                                        ...
                                        if($status_transaksi==1){
                                            ?>
                                            <a href="javascript:void(0)" data-toggle="tooltip" class="btn btn-xs m-r-5 btn-warning" title="Sedang Proses Penyewaan">OnPenyewaan</a>
                                            <?php
...
<div class="row"> 
    <div class="col-md-12"> 
        <div class="panel panel-inverse"> 
            <div class="panel-heading"> 
                <h4 class="panel-title">Foto Kondisi Barang</h4> 
            </div> 
            <div class="panel-body"> 
                            ...
                            <div class="image gallery-group-1">
                                <div class="image-inner">
                                    ...
                                    <p class="image-caption">
                                        #<?php echo $kode_transaksi;?><br/><?php echo $tgl_transaksi;?>
                                    </p>
                                </div>
                            </div>
                            <?php
