...
function kirim_email($kode_transaksi) {
    jQuery.post($BASE_URL+"sewa/kirim_email/"+$kode_transaksi,
    function(data){
        if(data.response=='true'){
            $.gritter.add({title:"Informasi Invoice !",text: "Nota Penyewaan Gagal Terkirim ke e-mail member !"});
        }else{
            $.gritter.add({title:"Informasi Invoice !",text: "Nota Penyewaan Terkirim ke e-mail member !"});
        }
    });
}
</script>
...
<div class="invoice">
    ...
    <div class="invoice-header">
        ...
        <div class="invoice-date">
            <small>Nota Penyewaan</small>
            <div class="date m-t-5"><?php echo $tgl_transaksi;?></div>
