					...
					class="table table-striped table-bordered nowrap" width="100%"> 
						<thead> 
							<tr> 
								...
								<th style="text-align:center" width="80%">Nama Pekerjaan</th>  
				...
				<form action="#" id="form" class="form-horizontal">
					...
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-6">
								<input name="nama" id="nama" maxlength="15" placeholder="Masukan Nama Pekerjaan" class="form-control" type="text">
